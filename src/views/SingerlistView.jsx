...
import { artistDesc, artistDetail, getArtistsSongs } from '../utils/service'
...
function SingerList(params) {
    ...
    const init = async() => {
        ...
        setState({...state, briefDesc: briefDesc, introduction: tabItems, songs: hotSongs, artist: artist,  isLoading: false});
    };
    ...
    return(
        <div className="container">
            <Spin spinning={state.isLoading}>
                ...
                <Row gutter={16}>
                    <Col span={6}>
                        {state.briefDesc && state.artist && <Card
                            hoverable
                            cover={<img src={state.artist.picUrl}/>}
                        >
                            <Meta title={state.artist.name} description={state.briefDesc}/>
                        </Card>}
                    </Col>
                    <Col span={16}>
                        <Space
